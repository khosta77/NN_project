...
class ModelAlBertClassifier(nn.Module):
    def __init__(self, model_name:str, max_len:int, n_classes:int, device):
        super(ModelAlBertClassifier, self).__init__()
        self.model = AlbertForSequenceClassification.from_pretrained(model_name, ignore_mismatched_sizes=True)
